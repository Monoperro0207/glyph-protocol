...
'@glyphp/server': major
'@glyphp/client': major
'@glyphp/conformance': major
'@glyphp/cli': major
'@glyphp/resolver': major
'@glyphp/adapter-mcp': major
'@glyphp/adapter-openapi': major
'@glyphp/adapter-mcp-server': major
...
Bump every package to **1.0.0** alongside the **Glyph Protocol 1.0** wire
